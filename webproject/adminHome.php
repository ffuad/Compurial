...
<body style="background-image: url('img/backgrnd1.jpg'); background-size: 100%;" >
    <div style="text-align: center;">
        <h1 style="color:#24282B;">Welcome <?=$_SESSION['username']?> to the home page.</h1>
        <h2 style="color:#24282B;">Press to add content in </h2> 
    
        <form method="post">
        <a href="adminPython.php" class="btn btn-primary" name="python"> Python</a> <br><br>
        <a href="adminML.php" class="btn btn-primary" name="ML"> Machine Learning</a> <br><br>
        <a href="adminCP.php" class="btn btn-primary" name="CP"> Competitive Programming</a>
        <br>
        </form>    
    </div>
