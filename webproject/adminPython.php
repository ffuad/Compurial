...
<div style="text-align: center;">
    ...
    <form action="#" method="post">
        ...
        <textarea style="background-color:#E5FEF1;" class="form-control" id="textArea" rows="10" name="content"></textarea><br>
    ...
    <?php
        ...
        if(isset($_POST['contentName']) ) {
            ...
            if($contentName!=null && $content!=null){
                ...
                $query = "INSERT INTO content_info( course_name, content_name, content) VALUES ('python', '$contentName', '$content')";
    ...
    <?php
        ...
        if(isset($_POST['deleteContentName'])){
            ...
            if($delContentName != null){
                $query = "DELETE FROM content_info WHERE content_name = '$delContentName' and course_name='python'";
    ...
    ?>
    <br>
    <a href="python.php"> <h5>Want to see the change? </h5> </a> 
