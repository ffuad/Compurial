...
<div style="text-align: center;">
        ...
        <?php
            ...
            if(isset($_POST['contentName']) ) {
                ...
                if($contentName!=null && $content!=null){
                    ...
                    $query = "INSERT INTO content_info( course_name, content_name, content) VALUES ('cp', '$contentName', '$content')";
    ...
    <?php
        ...
        if(isset($_POST['deleteContentName'])){
            ...
            if($delContentName != null){
                $query = "DELETE FROM content_info WHERE content_name = '$delContentName' and course_name='cp'";
    ...
    <br>
        ...
        <br>
        <a href="cp.php"> <h5>Want to see the change? </h5> </a> 
</div>
